...
switch ($tipo) {
    ...
    case "delete":
        ...
        registrarLog($conn, $_SESSION["usuario"], "Eliminó Ubuntu SSH '{$nombre}'");

        echo json_encode(["status" => "success", "message" => "Servidor Ubuntu SSH eliminado"]);
        exit;
...
registrarLog($conn, $_SESSION["usuario"], ucfirst($tipo) . " Ubuntu SSH '{$nombre}'");
