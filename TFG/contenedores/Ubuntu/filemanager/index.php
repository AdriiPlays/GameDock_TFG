...
<?php $nombreBase = preg_replace('/^ubuntu_/', '', $servidor); ?>
<button class="btn-volver" onclick="location.href='/TFG/contenedores/ubuntu/editar.php?nombre=<?= $nombreBase ?>'">
...
function abrir(ruta, esCarpeta) {
    ...
    if (esCarpeta) {
        location.href = "index.php?nombre=<?= $nombreBase ?>&ruta=" + encodeURIComponent(ruta);
    }
}
