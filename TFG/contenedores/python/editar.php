...
$stmt2 = $conn->prepare("SELECT * FROM python WHERE id = ?");
...
if (!$mc) {
    die("Datos de python no encontrados.");
}
...
$tituloPagina = "Editar Servidor python: " . htmlspecialchars($nombre);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<main class="contenido">
    ...
    <div class="tabs">
        ...
        <button class="tab-btn" onclick="openTab('dependencias')">📦 Dependencias</button>
...
<div id="estado" class="tab-content">
    ...
    <div id="dependencias" class="tab-content">

    <h2>Dependencias</h2>

    <h3>Instalar nuevas dependencias</h3>
    <textarea id="nuevasDependencias" class="input-edit" rows="5" placeholder="Ejemplo:&#10;discord.py&#10;requests"></textarea>
    <button class="btn-save" onclick="instalarDependencias()">Instalar</button>
    ...
    <div id="ftp" class="tab-content">
        ...
        <button class="btn-start" onclick="location.href='/TFG/contenedores/python/filemanager/index.php?nombre=<?= $nombre ?>'">
