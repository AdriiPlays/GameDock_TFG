...
<head>
    ...
    <title>Crear Servidor Plex</title>
...
<div class="main-content" id="main">
    ...
    <main class="contenido">
        ...
        <div class="form-box">
            ...
            <input type="text" id="nombre" class="input-edit" placeholder="Ej: plex01" autocomplete="off">

            <label for="claim">Token PLEX_CLAIM</label>
            <input type="text" id="claim" class="input-edit" placeholder="Ej: claim-xxxxxxxxxxxxxxxx" autocomplete="off">

            <p style="font-size:14px; margin-top:-10px; opacity:0.8;">
                Puedes obtener tu token aquí: 
                <a href="https://www.plex.tv/claim" target="_blank">https://www.plex.tv/claim</a>
            </p>
...
document.getElementById("btnCrear").addEventListener("click", () => {
    ...
    fetch("api/create.php", {
        ...
        body: JSON.stringify({ nombre, claim })
    })
    .then(r => r.json())
    .then(res => {
        ocultarLoader();
        ...
        if (res.status === "success") {
            mostrarAlertaOK("Servidor Plex creado correctamente", () => {
