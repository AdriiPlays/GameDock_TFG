...
// Si es IPv6 (contiene dos puntos), usamos localhost para evitar URLs tipo http://::1
if (strpos($ip, ':') !== false) {
    $ip = 'localhost';
}

$plexURL = "http://{$ip}:32400/web";
...
<div class="main-content" id="main">
    ...
    <header class="header">
        ...
        <h1>Gestión Plex: <?= htmlspecialchars($nombre) ?></h1>
    </header>
    ...
    <main class="contenido">
        ...
        <div class="tabs">
            ...
            <button class="tab-btn" onclick="openTab(event, 'web')">Plex Web</button>
        </div>
        ...
        <div id="ftp" class="tab-content">
            ...
            <p style="margin-bottom: 20px; opacity: 0.8;">
                Accede al gestor de archivos para administrar la biblioteca multimedia.
            </p>
        ...
        <div id="web" class="tab-content">
            <h2>Acceso a Plex Web</h2>

            <p>Puedes abrir la interfaz web de Plex desde aquí:</p>

            <a href="<?= $plexURL ?>" target="_blank" class="btn-start">
                🌐 Abrir Plex Web
            </a>
